...
export class SelectBoxExpressParser extends Parser {
	...
	public static readonly _serializedATN: string =
        ...
        "\n\x02\f\x02\x0E\x02\x02\x023\x02\x15\x03\x02\x02\x02\x04\x17\x03\x02" +
        "\x02\x02\x06\'\x03\x02\x02\x02\b+\x03\x02\x02\x02\n-\x03\x02\x02\x02\f" +
        "1\x03\x02\x02\x02\x0E3\x03\x02\x02\x02\x10\x16\x05\x04\x03\x02\x11\x12" +
