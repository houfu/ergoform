...
export class SelectItemsParser extends Parser {
	...
	public static readonly _serializedATN: string =
        ...
        "\x02\x02\'\x02\x1A\x03\x02\x02\x02\x04\x1E\x03\x02\x02\x02\x06 \x03\x02" +
        "\x02\x02\b$\x03\x02\x02\x02\n&\x03\x02\x02\x02\f\r\x07\x03\x02\x02\r\x12" +
        "\x05\x04\x03\x02\x0E\x0F\x07\x04\x02\x02\x0F\x11\x05\x04\x03\x02\x10\x0E" +
        "\x03\x02\x02\x02\x11\x14\x03\x02\x02\x02\x12\x10\x03\x02\x02\x02\x12\x13" +
        "\x03\x02\x02\x02\x13\x15\x03\x02\x02\x02\x14\x12\x03\x02\x02\x02\x15\x16" +
        "\x07\x05\x02\x02\x16\x1B\x03\x02\x02\x02\x17\x18\x07\x03\x02\x02\x18\x1B" +
        "\x07\x05\x02\x02\x19\x1B\x05\x04\x03\x02\x1A\f\x03\x02\x02\x02\x1A\x17" +
        "\x03\x02\x02\x02\x1A\x19\x03\x02\x02\x02\x1B\x03\x03\x02\x02\x02\x1C\x1F" +
        "\x05\b\x05\x02\x1D\x1F\x05\x06\x04\x02\x1E\x1C\x03\x02\x02\x02\x1E\x1D" +
        "\x03\x02\x02\x02\x1F\x05\x03\x02\x02\x02 !\x05\n\x06\x02!\"\x07\x06\x02" +
        "\x02\"#\x05\b\x05\x02#\x07\x03\x02\x02\x02$%\x07\x07\x02\x02%\t\x03\x02" +
        "\x02\x02&\'\x07\x07\x02\x02\'\v\x03\x02\x02\x02\x05\x12\x1A\x1E";
...
export class SelectItemsContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
        return SelectItemsParser.RULE_selectItems;
    }
...
export class ItemContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return SelectItemsParser.RULE_item;
    }
...
export class PairContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return SelectItemsParser.RULE_pair;
    }
...
export class ValueContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return SelectItemsParser.RULE_value;
    }
...
export class KeyContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return SelectItemsParser.RULE_key;
    }
